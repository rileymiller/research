...
\ref{fig:top10-pi}
\csmfigure{top10-pi}{figures/top10-pi}{6.5in}{Top 10 Requesters by Number of HITs }
adfkalsdmfdsamkl
...
\paragraph{LSI Analysis}
result of LSI on the number of topics, output the topics
\ref{fig:lsi-umass-description}
\ref{fig:lsi-uci-description}
\csmfigure{lsi-umass-description}{figures/lsi-umass-description}{5.5in}{LSI UMass Topic Coherence}
adfkalsdmfdsamkl

adsf asdf as
\csmfigure{lsi-uci-description}{figures/lsi-uci-description}{5.5in}{LSI UCI Topic Coherence}
...
\csmfigure{lda-umass-description}{figures/lda-umass-description}{5.5in}{LDA UMass Topic Coherence}
lorem ipsum

lorem ipsumlorem ipsumlorem ipsumlorem ipsumlorem ipsum
lorem ipsum
\csmfigure{lda-uci-description}{figures/lda-uci-description}{5.5in}{LDA UCI Topic Coherence}
...
\csmfigure{etm-umass-description}{figures/etm-umass-description}{5.5in}{ETM UMass Topic Coherence}

\ref{fig:etm-uci-description}
\csmfigure{etm-uci-description}{figures/etm-uci-description}{5.5in}{ETM UCI Topic Coherence}
...
\csmfigure{lsi-umass-title}{figures/lsi-umass-title}{5.5in}{LSI UMass Topic Coherence}

\ref{fig:lsi-uci-title}
\csmfigure{lsi-uci-title}{figures/lsi-uci-title}{5.5in}{LSI UCI Topic Coherence}
result of LSI on the number of topics, output the topics
visualization of document topic distribution
word clouds of top topics
t-SNE visualization
...
\csmfigure{lda-umass-title}{figures/lda-umass-title}{5.5in}{LDA UMass Topic Coherence}

\ref{fig:lda-uci-title}
\csmfigure{lda-uci-title}{figures/lda-uci-title}{5.5in}{LDA UCI Topic Coherence}
result of LDA on the number of topics, output the topics
visualization of document topic distribution
word clouds of top topics
t-SNE visualization
...
\csmfigure{etm-umass-title}{figures/etm-umass-title}{5.5in}{ETM UMass Topic Coherence}

\ref{fig:etm-uci-title}
\csmfigure{etm-uci-title}{figures/etm-uci-title}{5.5in}{ETM UCI Topic Coherence}
