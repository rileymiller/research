...
\textbf{To analyze common topics and trends found in crowdsourcing tasks on Amazon MTURK to\
...
form of topic modelling to improve the understanding of crowdsourcing tasks curated by researchers \ 
...
Briefly Discuss the dataset, touch on related work. Justification of literature here.
...
Give an overview of the most prominent topic models
\subsubsection{LSI}
...
What were the constraints (level/experience of the "worker" during the scrape)?

\paragraph{Architecture}
What were the tools used? 
What was the architecture of the data pipeline?

\paragraph{Duration}
What was the duration of the webscrape?

\paragraph{Document Explanation}
Talk about the actual fields that were collected

\paragraph{Related Works}
Is there any previous work on MTURK webscrapes, how does our data differ?
