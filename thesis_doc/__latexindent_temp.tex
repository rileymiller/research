...
\csmfigure{lda2vec}{figures/lda2vec_diagram}{3.65in}{lda2vec model architecture -- note the combination of the Skip grams from \emph{word2vec} \cite{mikolov2013distributed} used in conjunction with the LDA architecture \cite{blei2003latent}}
