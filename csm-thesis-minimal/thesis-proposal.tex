...
\title{Thesis Proposal: Micro-task Skill Inference for Crowdworkers}
...
goal of my research of improving crowdworker efficiency, as well as my approach to improve crowdworker efficiency\
using skill inference of micro-tasks in crowdsourcing platforms. I also provide background on related work on\
improving crowdworker efficiency that was derived from my research literature. Specifically, I highlight\
existing tools that crowdworkers use to be more efficient, task recommendation systems with\
common approaches, in addition to related work on the text classification and categorization of crowdsourcing tasks. Next, I\
provide an overview of the proposed work for my thesis development in which I touch on potential approaches to improve\
crowdworker efficiency, what my specific research focus will be, potential algorithms that I will develop to execute my\
...
to create and evaluate the implementations of my research approach. Finally, I describe an outline of my project timeline,\
...
and metadata of tasks, what the necessary skills to complete the task would be. This categorization will \ 
...
to surface relevant reccomendations to crowdworkers. Another set of researchers applied two different techniques based on \
...
inference method I will be researching I will require a large dataset of crowdworker interactions with tasks in crowdsourcing\
