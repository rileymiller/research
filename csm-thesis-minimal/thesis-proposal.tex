...
that are needed to complete a given task from the list. After I have collected and annotated the dataset of tasks,\
...
In addition to the supervised learning techniques outline above I also plan on experimenting with several unsupervised\
