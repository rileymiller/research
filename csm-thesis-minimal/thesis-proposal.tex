...
crowdsourcing site into an 80/20 split where 80\% of my data set will be used for training each machine learning\
algorithm while reserving the remaining 20\% of the data set to test the accuracy of the models and to evaluate\
which approach is most effective for determining which skills are necessary to perform tasks.
