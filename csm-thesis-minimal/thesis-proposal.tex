...
crowdsourcing platforms. As apart of a subsequent faction of the grant that this research is founded on, Dr.\
...
this approach are that we will be able to generate a sizeable corpus of raw text from HITs on Amazon MTurk but \
that we aren't going to be able to procure enough data on user sessions, user profiles, and user interactions\
under the time constraint of the grant to generate a collaborative filtering based recommendation system due
to forseeable initial adoption of the plugin.
